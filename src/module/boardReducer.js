    ...
    boards: [
        {
            boardId: 1,
            boardTitle: '제목 1',
            boardContent: '내용내용내용 1'
        },
        {
            boardId: 2,
            boardTitle: '제목 2',
            boardContent: '내용내용내용 2'
        },
        {
            boardId: 3,
            boardTitle: '제목 3',
            boardContent: '내용내용내용 3'
        },
        {
            boardId: 4,
            boardTitle: '제목 4',
            boardContent: '내용내용내용 4'
        },
        {
            boardId: 5,
            boardTitle: '제목 5',
            boardContent: '내용내용내용 5'
        }
    ],
    lastId: 5,
    selectRowData: {}
...
export default function boardReducer(state = initialState, action){
    ...
    switch(action.type){    // boardId 를 가지지 않는 data만 return
        case MODE_REMOVE:
            return{
        ...
        case MODE_SAVE:
            if(action.saveData.boardId === ''){ // boardId 가 없다면 신규 데이터 저장
                ...
                return {
                    ...state,
                    boards: state.boards.map(data => data.boardId === action.saveData.boardId ? {...action.saveData}: data),
                    selectRowData: {}
                };
            }
        case MODE_SELECT_ROW:
            return{ // boardId 를 가진 state (initData) 만 찾아서 return
                ...state,
